...
@export var local_left_hand: XRController3D
@export var local_right_hand: XRController3D
...
static var _static_left_hand: XRController3D
static var _static_right_hand: XRController3D
...
func _ready() -> void:
	...
	print("Left Hand: ", _static_left_hand)
	print("Right Hand: ", _static_right_hand)	
...
static func get_left_hand() -> XRController3D:
	return _static_left_hand

static func get_right_hand() -> XRController3D:
...
static func get_left_hand_global_euler_rotation() -> Vector3:
	if not _static_left_hand: return Vector3.ZERO
	return _static_left_hand.global_transform.basis.get_euler()

static func get_right_hand_global_euler_rotation() -> Vector3:
	if not _static_right_hand: return Vector3.ZERO
	return _static_right_hand.global_transform.basis.get_euler()
...
static func get_button_left_down_x_press() -> bool:
	if not _static_left_hand: return false
	return _static_left_hand.is_button_pressed("ax_button")  # or "x_button" depending on your action map

static func get_button_left_up_y_press() -> bool:
	if not _static_left_hand: return false
	return _static_left_hand.is_button_pressed("by_button")  # or "y_button"

static func get_button_right_down_a_press() -> bool:
	if not _static_right_hand: return false
	return _static_right_hand.is_button_pressed("ax_button")  # A on right = ax_button in many maps

static func get_button_right_up_b_press() -> bool:
	if not _static_right_hand: return false
	return _static_right_hand.is_button_pressed("by_button")

static func get_button_menu_left_press() -> bool:
	if not _static_left_hand: return false
	return _static_left_hand.is_button_pressed("menu_button")

# --------------------- Touch (finger on button, not necessarily pressed) ---------------------

static func get_button_left_down_x_touch() -> bool:
	if not _static_left_hand: return false
	return _static_left_hand.is_button_pressed("ax_touch")

static func get_button_left_up_y_touch() -> bool:
	if not _static_left_hand: return false
	return _static_left_hand.is_button_pressed("by_touch")

static func get_button_right_down_a_touch() -> bool:
	if not _static_right_hand: return false
	return _static_right_hand.is_button_pressed("ax_touch")

static func get_button_right_up_b_touch() -> bool:
	if not _static_right_hand: return false
	return _static_right_hand.is_button_pressed("by_touch")
...
static func get_left_joystick_2d_value() -> Vector2:
	if not _static_left_hand:
		return Vector2.ZERO
	
	for name in ["primary", "thumbstick", "joystick", "secondary"]:
		var value = _static_left_hand.get_vector2(name)
...
static func get_left_joystick_button_press() -> bool:
	...
	for name in [ "thumbstick_click", "joystick_button", "primary_click", "secondary_click"]:
		if _static_left_hand.is_button_pressed(name):
			return true
	return false
...
static func get_left_touch_pad_joystick_2d() -> Vector2:
	if not _static_left_hand: return Vector2.ZERO
...
static func get_right_touch_pad_joystick_2d() -> Vector2:
	if not _static_right_hand: return Vector2.ZERO
	for name in ["secondary"]:
		var value = _static_right_hand.get_vector2(name)
		if value.length() > 0.01:   # small deadzone
			return value
...
static func get_left_touch_pad_click_or_touch() -> bool:
	if not _static_left_hand: return false
	for name in ["secondary_click", "secondary_touch"]:
		if _static_left_hand.is_button_pressed(name):
			return true
	return false
